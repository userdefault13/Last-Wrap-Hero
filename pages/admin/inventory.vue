              ...
              <form @submit.prevent="saveItem" class="space-y-4">
                ...
                <div class="flex gap-4 pt-4">
                  ...
                  <button
                    type="submit"
                    :disabled="saving"
                    class="flex-1 btn-primary disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    <svg
                      v-if="saving"
                    ...
                    {{ saving ? 'Processing...' : (editingItem ? 'Update' : 'Create') }}
                  </button>
                </div>
              </form>
            </div>
